...
public class PesqClienteController implements Initializable {
    ...
    public void AlterCliente(ActionEvent event) throws IOException {
        ...
        int alterClienteId = table_lista_clientes.getSelectionModel().getSelectedItem().getCliente_id();
        String alterClienteNome = table_lista_clientes.getSelectionModel().getSelectedItem().getCliente_nome();
...
//         stage.setScene(new Scene(home_page_parent.load()));
//         stage.show();

...
Neste primeiro projeto utilizamos as seguintes tecnologias:
 - Linguagem Python;
 - Banco de dados postgresql ;
 - Biblioteca do Google Speech Recognition para reconhecimento de voz;
...
<p align="center"><b>Para acessar o repositório completo deste projeto é só acessar através do votão abaixo: </b><br>  <a href="https://github.com/rodrigo-prado1705/Sarah"> <img src= "https://github.com/MaXximiles/Fatec/blob/master/src/acesseaquisarah.fw.png" width="100" height="40"></a></p> <br>
...
Neste segundo projeto utilizamos as seguintes tecnologias:
 - Linguagem Java;
 - JavaFX para Frontend;
...
<p align="center"><b>Acesse o repositório completo clicando abaixo</b><br><a href="https://github.com/labarro/projeto-integrador-2sem"> <img src= "https://github.com/MaXximiles/Fatec/blob/master/src/acesseaquiyourcad.fw.png" width="100" height="40"></a></p> <br>
...
Neste terceiro projeto utilizamos as seguintes tecnologias:
 - Java com Springboot;
 - NodJs com React;
 - iPDF para leitura de arquivos pdf;
 - Banco de Dados MySql;
 - Heroku para hospedagem do backend e frontend;
...
<p>Com o agendamento das salas o público externo poderá ser cadastrado no sistema para participar dos eventos, seguindo a validação do comprovante de vacinação contra SARS-CoV-2, tanto para dose única quanto para demais doses. Os usuários cadastrados serão notificados sobre novos eventos e atualizações via e-mail.</p>
 ...
 Neste quarto projeto utilizaram as seguintes tecnologias:
  - Java com Springboot;
  - Angular;
